...
u8 fuzz_one_original(afl_state_t *afl) {
  ...
  /* DeepFuzz: save original havoc_stack_pow2 */
  u8  orig_havoc_stack_pow2 = afl->havoc_stack_pow2;
...
havoc_stage:
  ...
  if (afl->depth_mode_active && afl->depth_model.loaded && afl->queue_cur) {
    ...
    if (deepfuzz_is_deep_seed(afl, afl->queue_cur)) {
      ...
      afl->havoc_stack_pow2 = 6;   /* 1-64 aggressive */
...
abandon_entry:
  ...
  /* DeepFuzz: restore original havoc_stack_pow2 */
  afl->havoc_stack_pow2 = orig_havoc_stack_pow2;
